...
- Survoler les chutes de Kaieteur, cinq fois plus hautes que les chutes du Niagara
- Dormir dans un lodge en pleine forêt primaire et observer la faune nocturne
- Naviguer sur l'Essequibo, l'un des plus grands fleuves d'Amérique du Sud
- Rencontrer les communautés amérindiennes et partager leur quotidien
- Observer des espèces rares : jaguar, loutre géante, harpy eagle
- Vivre l'aventure de l'exploration dans un pays encore quasi vierge
...
- **Mai à août** : grande saison des pluies — rivières hautes, certaines zones inaccessibles

**À savoir** : les déplacements intérieurs se font principalement en petit avion ou en pirogue. Les infrastructures sont très limitées hors de Georgetown.

## Combien de temps partir ? 👀

- **7 à 10 jours** : les essentiels (Georgetown, Kaieteur, un lodge en forêt)
- **12 à 16 jours** : version complète avec Rupununi, savane et communautés amérindiennes
- **+16 jours** : immersion totale avec exploration des rivières et zones reculées

## Ce que je construis pour toi ? 💚

C'est une destination où chaque détail compte : les vols internes, les lodges fiables, les guides locaux, les autorisations d'accès aux terres amérindiennes…

Je conçois un itinéraire sur-mesure, pensé pour que tu profites à 100% : hébergements sélectionnés, logistique maîtrisée, guides de confiance… et un roadbook clair pour vivre ton voyage pleinement, sans te poser de questions.
